  ...
  <head>
	...
	<?php
		...
		if(isset($_POST['envoyerMessage'])){
			...
			//je me suis dit on a pas besoin de l'id de l'utilisateur car on est pas obligé d'etre inscrit pour envoyer un msg à l'admin...

			/*$prenom = $_POST['prenom'];
			$nom = $_POST['nom'];
			$objet = $_POST['objet'];
			$message = $_POST['message'];
			$destinataire = 'fakeadressemail36.com';
			$header = "From:\"nash\"<hraouli13@gmail.com>\n";
			$header .="Reply-To:hraouli13@gmail.com\n";
			$header .="Content-Type:text/html; charset=\"iso-8859-1\"";*/

			$destinataire = $_POST['mail'];
			$prenom = $_POST['prenom'];
			$nom = $_POST['nom'];
			$to      = 'hraouli13@gmail.com';
			$subject = $_POST['objet'];
			$message = $_POST['message'];
			...
			$texte_du_mail= $nom." ".$prenom."vous a envoyé un message";

			mail($destinataire, $subject, $texte_du_mail, $headers);
