			...
			if(!(isset($_SESSION['user_connexion']))){
				...
				<?php
					...
					if(isset($_POST['ajouterObjet'])){
						...
						$requete_insertion_objet="INSERT INTO objets VALUES('".$id."','".$titre."', '".$categories."', '".$description."')";
						$resultat_insertion =mysqli_query($connexion_insertion,$requete_insertion_objet);
					}
